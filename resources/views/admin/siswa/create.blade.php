        ...
        <div class="mx-auto flex min-h-[70vh] w-full max-w-5xl items-center justify-center">
            <div class="w-full max-w-md rounded-2xl border border-orange-200 bg-white p-6 shadow-sm sm:p-8">
                <div class="mb-3 flex justify-end">
                    <a href="/siswa" class="rounded-md bg-orange-500 px-4 py-2 text-sm font-medium text-white transition hover:bg-orange-600">Back</a>
                </div>
                <h2 class="text-center text-2xl font-bold text-black">Tambah Siswa</h2>
                <p class="mt-1 text-center text-sm text-gray-500">Isi data siswa baru di bawah ini.</p>
                ...
                <form action="/siswa" method="POST" class="mt-6 space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" id="nis" name="nis" value="{{ old('nis') }}" placeholder="NIS"
                            class="w-full rounded-lg border border-orange-200 px-3 py-2 text-sm text-gray-700 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200">
                    </div>

                    <div>
                        <label for="password" class="mb-1 block text-xs font-semibold uppercase tracking-wide text-black">Password</label>
