    ...
    <div class="min-h-screen bg-[#F6EFE7] px-4 py-10">
        <div class="mx-auto flex min-h-[70vh] w-full max-w-5xl items-center justify-center">
            <div class="w-full max-w-md rounded-2xl border border-orange-200 bg-white p-6 shadow-sm">
                ...
                <h2 class="text-center text-2xl font-bold text-black">Tambah Kategori</h2>
                <p class="mt-1 text-center text-sm text-gray-500">Isi nama kategori baru di bawah ini.</p>
                ...
                <form method="POST" action="/kategori" class="mt-6 space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_kategori" name="nama_kategori" value="{{ old('nama_kategori') }}" placeholder="Nama Kategori"
